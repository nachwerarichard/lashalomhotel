...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Send booking confirmation email without the cancellation link
    ...
    try {
        ...
        //Recipients
        $mail->setFrom($email,$fname); // Replace with your email and hotel name
...
<body>
    ...
    <div class="hotel-info">
        <p>Thank you for booking.We shall get back to you.</p>
        <p><a href='http://localhost/hotel_booking/lashalomhotel/cancel_booking.php?token=$cancellation_token'>Click here to cancel your booking</a></p>
    </div>
